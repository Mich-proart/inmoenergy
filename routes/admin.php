...
Route::group(['prefix' => 'api'], function () {
    ...
    Route::get('/formality/assignment/renovation', [FormalityApiController::class, 'getRenewable'])->name('api.formality.assignment.renovation');
    ...
    Route::get('/ticket/formality', [TicketApiController::class, 'getFormalityTicket'])->name('api.formality.ticket');
...
Route::prefix('formality')->group(function () {
    ...
    Route::get('/create/client', [FormalityAdminController::class, 'createClient'])->name('admin.formality.create.client');
...
Route::prefix('tickets')->group(function () {
    ...
    Route::get('/{id}/modify', [TicketAdminController::class, 'modify'])->name('admin.ticket.modify');
});
