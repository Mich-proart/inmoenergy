...
function workerDoughnutfnt(set_data) {
...
function workerHorizontalBarfnt(set_data) {
    const result = set_data.reduce((acc, target) => {
...
function workerVerticalBarfnt(set_data) {

    if (set_data === null) return workerChartsInit().verticalBar;
