...
class updateFormalityFields extends Form
{
    ...
    protected $rules = [
        ...
        'documentTypeId' => 'required|nullable|integer|exists:document_type,id',
        'documentNumber' => 'required|nullable|string',
        'phone' => 'required|nullable|string',
        'clientTypeId' => 'required|nullable|integer|exists:client_type,id',
        'userTitleId' => 'required|nullable|integer|exists:user_title,id',
        'IBAN' => 'required|nullable|string',
        'locationId' => 'required|nullable|exists:location,id',
        'streetTypeId' => 'required|nullable|exists:street_type,id',
        'housingTypeId' => 'required|nullable|exists:housing_type,id',
        'streetName' => 'required|nullable|string',
        'streetNumber' => 'required|nullable|string',
        'zipCode' => 'required|nullable|string',
