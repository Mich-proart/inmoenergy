            ...
            <form wire:submit="save">
                ...
                <section>
                            ...
                            <div class="col">
                                @if (isset($services))
                                    @foreach ($services as $service)
                                        <div class="form-check form-check-inline">
                                            <input wire:model="form.serviceIds" class="form-check-input" type="checkbox"
                                                   id=""
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                <label for="">¿El cliente quiere tramitar el alta de otros servicios? Marcar los
                                    servicios en los que está interesado.</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-1">
                            ...
                            <select wire:model="form.userTitleId"
                                    ...
                                    name="userTitleId"
                                    id="userTitleId" :disabled="type === '{{$businessClientType->id}}'"
                                ...
                                <ul class="dropdown-menu">
                                    @isset($countries)
                                        @foreach ($countries as $country)
                                            <li wire:click="changeCountry({{$country->id}})"><a class="dropdown-item"
                                                                                                href="#">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            ...
                            <input wire:model="form.door" type="text"
                                   class="form-control @error('form.door') is-invalid @enderror" id="inputZip"
                                   name="door">
                            @error('form.door')
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#IBAN").keydown((e) => {
                ...
                const inputLength = e.target.value.replace(/ /g, "").length;
                if (inputLength >= 24) {
                    e.preventDefault();
                }
            ...
            $("#IBAN").on('input', (e) => {
                ...
                if (valuesOfInput.length <= 2 && !new RegexValidator(/^[A-Z]{1,2}$/).check(valuesOfInput)) {
                    e.target.value = valuesOfInput.slice(0, -1);
                    return;
                }

                if (valuesOfInput.length > 2 && valuesOfInput.length <= 4 && !new RegexValidator(/^[A-Z]{2}\d{1,4}$/).check(valuesOfInput)) {
                    e.target.value = valuesOfInput.slice(0, -4);
                    return;
                }
                ...
                if (valuesOfInput) {
                    ...
                    if (valuesOfInput.length > 17) {
                        e.target.value = valuesOfInput.replace(/(\d{4})(\d{4})(\d{4})(\d{2})(\d{0,10})/, "$1 $2 $3 $4 $5");
                    } else if (valuesOfInput.length > 14) {
                        e.target.value = valuesOfInput.replace(/(\d{4})(\d{4})(\d{4})(\d{0,2})/, "$1 $2 $3 $4");
                    } else if (valuesOfInput.length > 9) {
                        e.target.value = valuesOfInput.replace(/(\d{4})(\d{4})(\d{0,4})/, "$1 $2 $3");
                    } else if (valuesOfInput.length > 4) {
                        e.target.value = valuesOfInput.replace(/(\d{4})(\d{0,4})/, "$1 $2");
                    } else {
                        e.target.value = valuesOfInput.replace(/(\d{0,4})/, "$1");
                    }
                }
            });
            */
            ...
            $("#IBAN").keypress((e) => {
                ...
                console.log(new RegexValidator(/^[A-Z]{1,2}$/).check(valuesOfInput))


                if (e.target.value) {


                    if (e.target.value.length <= 2 && new RegexValidator(/^[A-Z]{1,2}$/).check(valuesOfInput) === false) {
                        e.preventDefault();
                    }

                    if (e.target.value.length > 2 && e.target.value.length <= 4 && new RegexValidator(/^[A-Z]{2}\d{1,4}$/).check(valuesOfInput) === false) {
                        e.preventDefault();
                    }
