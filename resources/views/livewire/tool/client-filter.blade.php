                ...
                <div class="row align-items-center">
                    <div class="col-2">
                        <div class="dropdown">
                            <button class="btn btn-light dropdown-toggle" type="button" data-bs-toggle="dropdown"
                                ...
                                @if(empty($selectedBusinessGroups))
                                    Grupo Empresarial
                                @elseif($allBusinessGroups)
                                    Todos
                                @elseif(!empty($selectedBusinessGroups))
                                    Opciones ({{count($selectedBusinessGroups)}})
                                @endif
                            </button>
                            <ul class="dropdown-menu">
                                <li>
                                    <div class="dropdown-item">
                                        <input wire:model="allBusinessGroups" wire:click="selectAllBusinessGroups"
                                            type="checkbox">
                                        Todos
                                    </div>
                                </li>
                                @foreach ($businessGroups as $group)
                                    <li>
                                        <div class="dropdown-item">
                                            <input wire:model.live="selectedBusinessGroups"
                                                wire:change="isAllCheckBusinessGroups" type="checkbox" name="" id=""
                                                value="{{ $group->id }}">
                                            {{ ucfirst($group->name) }}
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="dropdown-item">
                                            <input wire:model.live="selectedUsers" wire:change="isAllCheckUsers"
                                                type="checkbox" name="" id="" value="{{ $user->id }}">
                                    ...
                                    <li>
                                        <div class="dropdown-item">
                                            <input wire:model.live="selectedServices" wire:change="isAllcheckService"
                                                type="checkbox" name="" id="" value="{{ $service->id }}">
                    ...
                    <div class="col-2">
                        <select wire:model="selectedFrequency" wire:change="onParamsChange" name="frequency"
                            id="frequencySet" class="form-control">
