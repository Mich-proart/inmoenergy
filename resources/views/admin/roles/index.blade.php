...
<div>
    <div class="card card-primary card-outline">
            ...
            <div class="row no-print">
                <div class="col-12">
                    <div>
                        ...
                        @role('superadmin')
                        <livewire:role.create-role-modal />
                        @endrole
        ...
        <div class="card-body table-responsive p-0">
            <table id="roles-content" class="table table-hover text-nowrap" style="cursor:pointer">
                <thead>
                    <tr>
                        <th>Nombre</th>
                        <th>Opciones</th>
...
<script>
    ...
    $('#roles-content').on('click', '.target', function () {
        const row = table.row(this).data();
        console.log(row);
        window.location.href = "{{ route('admin.roles.edit', ':id') }}".replace(':id', row.id);
    })
