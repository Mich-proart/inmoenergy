                    ...
                    <tr>
                        <td align="center" style="padding:0;Margin:0">
                            <table cellspacing="0" cellpadding="0" align="center" class="es-content-body"
                                ...
                                <tr>
                                    <td align="left"
                                        style="Margin:0;padding-top:20px;padding-right:20px;padding-bottom:5px;padding-left:20px">
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <p
                                                                    ...
                                                                    información sobre la contratación de servicio de alarma para el hogar en la dirección:
                                                                    {{$streetType->name}} {{' '}}
                                                                    {{$address['street_name']}} {{' '}}
